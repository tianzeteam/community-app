...
public class StatisticPage implements Serializable {
    ...
    public StatisticPage withId(Integer id) {
        this.setId(id);
        return this;
    }
    ...
    public StatisticPage withContents(String contents) {
    ...
    public StatisticPage withUrl(String url) {
        this.setUrl(url);
        return this;
    }
    ...
    public StatisticPage withCategory(Integer category) {
    ...
    public StatisticPage withCategoryName(String categoryName) {
    ...
    public StatisticPage withRevision(Integer revision) {
    ...
    public StatisticPage withCreatedBy(Long createdBy) {
    ...
    public StatisticPage withCreatedTime(Date createdTime) {
    ...
    public StatisticPage withUpdatedBy(Long updatedBy) {
    ...
    public StatisticPage withUpdatedTime(Date updatedTime) {
    ...
    public boolean equals(Object that) {
        ...
        StatisticPage other = (StatisticPage) that;
     ...
     * This enum corresponds to the database table public.statistic_page
     *
     * @mbg.generated
