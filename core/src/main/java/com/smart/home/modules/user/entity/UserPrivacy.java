...
public class UserPrivacy implements Serializable {
    ...
    public UserPrivacy withId(Integer id) {
        this.setId(id);
        return this;
    }
    ...
    public UserPrivacy withCategory(Integer category) {
    ...
    public UserPrivacy withCategoryName(String categoryName) {
    ...
    public UserPrivacy withCode(Integer code) {
        this.setCode(code);
        return this;
    }
    ...
    public UserPrivacy withTitle(String title) {
        this.setTitle(title);
        return this;
    }
    ...
    public UserPrivacy withRevision(Integer revision) {
    ...
    public UserPrivacy withCreatedBy(Long createdBy) {
    ...
    public UserPrivacy withCreatedTime(Date createdTime) {
    ...
    public UserPrivacy withUpdatedBy(Long updatedBy) {
    ...
    public UserPrivacy withUpdatedTime(Date updatedTime) {
     ...
     * This enum corresponds to the database table public.user_privacy
     *
     * @mbg.generated
    ...
    public enum Column {
         ...
         * This field corresponds to the database table public.user_privacy
         *
         * @mbg.generated
         * @project https://github.com/itfsw/mybatis-generator-plugin
         */
         ...
         * This method corresponds to the database table public.user_privacy
         *
         * @mbg.generated
         * @project https://github.com/itfsw/mybatis-generator-plugin
         */
