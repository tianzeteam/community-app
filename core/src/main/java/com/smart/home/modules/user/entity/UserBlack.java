...
public class UserBlack implements Serializable {
    ...
    public UserBlack withId(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public UserBlack withUserId(Long userId) {
    ...
    public UserBlack withBlackUserId(Long blackUserId) {
        this.setBlackUserId(blackUserId);
        return this;
    }
    ...
    public UserBlack withHeadUrl(String headUrl) {
    ...
    public UserBlack withNickName(String nickName) {
    ...
    public UserBlack withCreatedTime(Date createdTime) {
     ...
     * This enum corresponds to the database table public.user_black
     *
     * @mbg.generated
    ...
    public enum Column {
        ...
        blackUserId("black_user_id", "blackUserId", "BIGINT", false),
