...
public class SubjectCard implements Serializable {
    ...
    public SubjectCard withId(Integer id) {
        this.setId(id);
        return this;
    }
    ...
    public SubjectCard withCoverImage(String coverImage) {
    ...
    public SubjectCard withBannerImages(String bannerImages) {
    ...
    public SubjectCard withTitle(String title) {
        this.setTitle(title);
        return this;
    }
    ...
    public SubjectCard withSubTitle(String subTitle) {
    ...
    public SubjectCard withSourceId(Long sourceId) {
    ...
    public SubjectCard withCategory(Integer category) {
    ...
    public SubjectCard withCategoryName(String categoryName) {
    ...
    public SubjectCard withUrl(String url) {
        this.setUrl(url);
        return this;
    }
    ...
    public SubjectCard withRevision(Integer revision) {
    ...
    public SubjectCard withCreatedBy(Long createdBy) {
    ...
    public SubjectCard withCreatedTime(Date createdTime) {
    ...
    public SubjectCard withUpdatedBy(Long updatedBy) {
    ...
    public SubjectCard withUpdatedTime(Date updatedTime) {
    ...
    public boolean equals(Object that) {
        ...
        SubjectCard other = (SubjectCard) that;
     ...
     * This enum corresponds to the database table public.subject_card
     *
     * @mbg.generated
